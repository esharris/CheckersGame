...
public final class BoardRow {
    ...
    /**
     * In the enclosing board, this is the location. This makes the objects
     * smarter, but less normalized.
     */
    ...
    public String toString() {
        ...
        String separator = "";
        for (Cell buffer1 : buffer) {
            stringBuilder.append(separator);
            stringBuilder.append(buffer1.toString());
